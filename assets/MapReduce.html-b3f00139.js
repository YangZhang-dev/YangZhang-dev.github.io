import{_ as n,o as s,c as a,e as t}from"./app-1ddc0141.js";const p={},o=t(`<p>本文会将一下我的设计思路，没有做过实验的还是希望自己调试出来再看，本人新手菜鸟，如果有问题还请多多指教。</p><p>lab1总体实现起来还是清晰明了的，没有那么难，主要是再三个文件上修修改改，所以以代码和注释为主。</p><h2 id="task" tabindex="-1"><a class="header-anchor" href="#task" aria-hidden="true">#</a> Task</h2><p>首先明确MapReduce中的核心：任务。所以在这里定义一些任务的类型：</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// 定义任务类型</span>
