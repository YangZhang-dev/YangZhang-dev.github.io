import{_ as i,W as n,X as e,a1 as d,Y as s,$ as l}from"./framework-6ad85d54.js";const v={},a=s("p",null,"有关图的算法，包括最短路，最小生成树，二分图",-1),r=l(`<figure><img src="http://blog-zzys.oss-cn-beijing.aliyuncs.com/articles/e47ce8d5e2a4321c42eeb251da54e3b9.png" alt="最短路.drawio.png" tabindex="0" loading="lazy"><figcaption>最短路.drawio.png</figcaption></figure><h1 id="最短路" tabindex="-1"><a class="header-anchor" href="#最短路" aria-hidden="true">#</a> 最短路</h1><h2 id="_1-单源最短路" tabindex="-1"><a class="header-anchor" href="#_1-单源最短路" aria-hidden="true">#</a> 1. 单源最短路</h2><h3 id="_1-1-dijkstra算法" tabindex="-1"><a class="header-anchor" href="#_1-1-dijkstra算法" aria-hidden="true">#</a> 1.1 Dijkstra算法</h3><p>对于没有负权边的单源最短路问题，通常使用Dijkstra算法解决，其中当图是稀疏图时，考虑使用堆优化版的Dijkstra算法，稠密图使用朴素版的Dijkstra算法</p><h4 id="_1-1-1-朴素版的dijkstra算法" tabindex="-1"><a class="header-anchor" href="#_1-1-1-朴素版的dijkstra算法" aria-hidden="true">#</a> 1.1.1 朴素版的Dijkstra算法</h4><ol><li>初始化起点为0，其他点为正无穷，定义<code>s数组</code>为已经确定最短路的点</li><li>循环n次，每次选取不在集合<code>s</code>中，距离起点最近的点<code>t</code>，加入集合<code>s</code>中，更新其他点的最短路径</li></ol><p>常用模板：</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>#include &lt;bits/stdc++.h&gt;
