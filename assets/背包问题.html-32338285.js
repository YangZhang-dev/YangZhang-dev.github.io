...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="完全背包" tabindex="-1"><a class="header-anchor" href="#完全背包" aria-hidden="true">#</a> 完全背包</h2><p>在01背包问题的基础上，每一个物品可以无限制的选择。</p><h3 id="朴素-1" tabindex="-1"><a class="header-anchor" href="#朴素-1" aria-hidden="true">#</a> 朴素</h3><p>同样使用闫式dp法，dp分析图和01背包相同。集合划分如下：</p><figure><img src="https://blog-zzys.oss-cn-beijing.aliyuncs.com/articles/完全背包集合划分.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>我们将集合划分为不选第i个物品，选1个第i个物品，....，选k个第i个物品。</p><p>有转移方程：<code> dp[i][j] = max(dp[i][j], dp[i - 1][j - k * v[i]] + k * w[i])</code>，注意不选第i个物品即k等于0的情况，所以不需要单独讨论。</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>#include &lt;bits/stdc++.h&gt;
#define rep(i,l,r) for (int i = (l); i &lt;= (r); ++ i)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,49),v=[s];function a(r,c){return n(),e("div",null,v)}const m=i(l,[["render",a],["__file","背包问题.html.vue"]]);export{m as default};
