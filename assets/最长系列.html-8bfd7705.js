...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="最长递增子序列" tabindex="-1"><a class="header-anchor" href="#最长递增子序列" aria-hidden="true">#</a> 最长递增子序列</h2><h3 id="dp定义-1" tabindex="-1"><a class="header-anchor" href="#dp定义-1" aria-hidden="true">#</a> dp定义</h3><p>dp[i]表示i之前包括i的<strong>以nums[i]结尾</strong>的最长递增子序列的长度</p><h3 id="转移方程-1" tabindex="-1"><a class="header-anchor" href="#转移方程-1" aria-hidden="true">#</a> 转移方程</h3><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>if(nums[i] &gt; nums[j]) dp[i] = max(dp[i], dp[j] + 1)
else {}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,72);function _(z,L){const e=a("ExternalLinkIcon");return l(),r("div",null,[u,v,m,i("table",null,[o,i("tbody",null,[i("tr",null,[b,i("td",null,[i("a",p,[n("最长连续递增序列"),d(e)])]),i("td",null,[i("a",h,[n("最长重复子数组"),d(e)])])]),i("tr",null,[g,i("td",null,[i("a",f,[n("最长递增子序列"),d(e)])]),i("td",null,[i("a",x,[n("最长公共子序列"),d(e)])])])])]),j])}const S=s(t,[["render",_],["__file","最长系列.html.vue"]]);export{S as default};
