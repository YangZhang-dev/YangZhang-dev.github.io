import{_ as l,r as d,o as a,c as r,a as i,b as n,d as s,e as t}from"./app-8f4b6e6f.js";const v={},c={href:"https://leetcode.cn/problems/merge-two-sorted-lists/description/",target:"_blank",rel:"noopener noreferrer"},u={href:"https://leetcode.cn/problems/merge-k-sorted-lists/description/",target:"_blank",rel:"noopener noreferrer"},m=t(`<h2 id="合并两个有序链表" tabindex="-1"><a class="header-anchor" href="#合并两个有序链表" aria-hidden="true">#</a> 合并两个有序链表</h2><p>将两个有序的链表合成为一个有序链表</p><h3 id="递归" tabindex="-1"><a class="header-anchor" href="#递归" aria-hidden="true">#</a> 递归</h3><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>ListNode* mergeTwoLists(ListNode* list1, ListNode* list2) {
