import{_ as d,r as a,o as r,c as v,a as i,b as n,d as l,e as s}from"./app-e8546741.js";const c={},t=s(`<h2 id="位运算" tabindex="-1"><a class="header-anchor" href="#位运算" aria-hidden="true">#</a> 位运算</h2><p>计算机中的数在内存中都是以二进制形式进行存储的，用位运算就是直接对整数在内存中的二进制位进行操作，因此其执行效率非常高，在程序中尽量使用位运算进行操作，这会大大提高程序的性能。</p><h3 id="位运算的常见技巧" tabindex="-1"><a class="header-anchor" href="#位运算的常见技巧" aria-hidden="true">#</a> 位运算的常见技巧</h3><ol><li>位运算实现乘除</li></ol><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>int a=2;
a&gt;&gt;1; --&gt;1
a&lt;&lt;1; --&gt;4
