import{_ as l,W as v,X as a,Y as i,Z as d,a0 as s,$ as n,E as c}from"./framework-6ad85d54.js";const r={},t=n(`<p>链表创建有两种方式，一种是：</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>struct Node
{
  int num;
  Node* next;
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这种动态创建链表在new新节点的方式很慢</p><p>另一种就是用数组模拟链表</p><h2 id="单链表" tabindex="-1"><a class="header-anchor" href="#单链表" aria-hidden="true">#</a> 单链表</h2><p>在单链表中，用的最多的时邻接表，常常用它来存储树和图</p><p>一般使用e数组存储节点的值，ne数组存储下一个位置的指针</p><figure><img src="http://blog-zzys.oss-cn-beijing.aliyuncs.com/articles/33b136d4cc485b398722f33a53eef64c.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><h3 id="实现" tabindex="-1"><a class="header-anchor" href="#实现" aria-hidden="true">#</a> 实现</h3>`,9),u={href:"https://www.acwing.com/activity/content/problem/content/863/",target:"_blank",rel:"noopener noreferrer"},m=n(`<div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>#include&lt;bits/stdc++.h&gt;
using namespace std;
