import{_ as a,r as l,o as r,c,a as i,b as s,d,e as n}from"./app-1ddc0141.js";const v={},t=n(`<h2 id="一维差分" tabindex="-1"><a class="header-anchor" href="#一维差分" aria-hidden="true">#</a> 一维差分</h2><p>一维差分主要解决的是需要在一维区间内进行大量的加减常数</p><h3 id="思考步骤" tabindex="-1"><a class="header-anchor" href="#思考步骤" aria-hidden="true">#</a> 思考步骤</h3><p>给定一个数组s，当需要在一个区间内进行加减常数时，暴力循环明显时O(n)的时间复杂度。 如果我们构建一个数组a，使得原数组s是a的前缀和数组，那么a也就是s的差分数组 我们可以发现，当需要s在[l,r]加c时，我们只需要对于a[l]+c,a[r+1]-c，即可在O(1)内完成操作，最后再求一下前缀和就是答案</p><h3 id="公式" tabindex="-1"><a class="header-anchor" href="#公式" aria-hidden="true">#</a> 公式</h3><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>void insert(int l,int r,int c)
{
  a[l]+=c;
  a[r+1]-=c;
}
