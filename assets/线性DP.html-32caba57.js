import{_ as i,o as n,c as e,e as d}from"./app-e8546741.js";const s={},l=d(`<h2 id="线性dp" tabindex="-1"><a class="header-anchor" href="#线性dp" aria-hidden="true">#</a> 线性DP</h2><p>类似于背包问题，即状态的转换是以线性递推的形式进行的。分析问题的方式同样是闫式DP的方法。下面是几道例题。</p><h3 id="数字三角形" tabindex="-1"><a class="header-anchor" href="#数字三角形" aria-hidden="true">#</a> 数字三角形</h3><h4 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h4><p>给定一个如下图所示的数字三角形，从顶部出发，在每一结点可以选择移动至其左下方的结点或移动至其右下方的结点，一直走到底层，要求找出一条路径，使路径上的数字的和最大。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>        7
      3   8
    8   1   0
  2   7   4   4
4   5   2   6   5
