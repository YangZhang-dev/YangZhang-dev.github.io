import{_ as l,r as v,o as a,c as r,a as n,b as i,d as s,e}from"./app-1ddc0141.js";const c={},u=e(`<p>深度优先遍历简称DFS，是一种树或图的遍历方式，他会优先向下遍历，直到走到末尾，然后回溯到上一个节点</p><h2 id="实现" tabindex="-1"><a class="header-anchor" href="#实现" aria-hidden="true">#</a> 实现</h2><p>dfs可以用递归进行实现，dfs的一般模板为</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>void  DFS（结点类型 current）  // 从结点current出发递归地深度优先搜索
    {
