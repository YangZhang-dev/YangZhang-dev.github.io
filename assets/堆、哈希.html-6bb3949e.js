import{_ as d,W as a,X as v,Y as i,Z as l,a0 as s,$ as n,E as r}from"./framework-6ad85d54.js";const c={},u=n(`<h2 id="堆" tabindex="-1"><a class="header-anchor" href="#堆" aria-hidden="true">#</a> 堆</h2><p>堆是一颗完全二叉树，小根堆的每一个节点的值都小于他的子节点的值</p><h3 id="存储" tabindex="-1"><a class="header-anchor" href="#存储" aria-hidden="true">#</a> 存储</h3><p>可以使用一维数组来存储堆，注意下标从一开始</p><figure><img src="http://blog-zzys.oss-cn-beijing.aliyuncs.com/articles/ecdd3bf22bb1bf0db2c30565e21e083f.png" alt="DEZ52PA7L8TZ1\`9QL2EA.png" tabindex="0" loading="lazy"><figcaption>DEZ52PA7L8TZ1\`9QL2EA.png</figcaption></figure><p>这里就有两种基础操作：</p><ol><li>down() 当一个数变大时，down(k)是将这个节点向下沉</li><li>up() 当一个数变小时，up(k)是将这个节点向上浮</li></ol><h3 id="操作" tabindex="-1"><a class="header-anchor" href="#操作" aria-hidden="true">#</a> 操作</h3><p>通过数组模拟小根堆可以实现的操作：</p><ol><li>插入一个数</li></ol><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>heap(++size)=x;
up(size);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="拉链法" tabindex="-1"><a class="header-anchor" href="#拉链法" aria-hidden="true">#</a> 拉链法</h3><p>开一个一维数组，将每一个元素都当成链表的头指针，即</p><figure><img src="http://blog-zzys.oss-cn-beijing.aliyuncs.com/articles/61eac60a113aef196bcb445fa9589544.png" alt="_LMR3TV1A9HS7~3G.png" tabindex="0" loading="lazy"><figcaption><sub>_</sub>LMR3TV<sub>1</sub>A9HS7~3G.png</figcaption></figure><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>#include &lt;iostream&gt;
#include &lt;cstring&gt;
using namespace std;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function p(x,f){const e=r("ExternalLinkIcon");return a(),v("div",null,[u,i("p",null,[i("a",t,[l("堆排序"),s(e)])]),m,i("p",null,[i("a",b,[l("模拟散列表"),s(e)])]),o,i("p",null,[i("a",h,[l("字符串哈希"),s(e)])]),g])}const k=d(c,[["render",p],["__file","堆、哈希.html.vue"]]);export{k as default};
