import{_ as d,r as l,o as s,c as r,a as e,b as i,d as a,e as c}from"./app-8f4b6e6f.js";const t={},o={href:"https://leetcode.cn/problems/sqrtx/description/",target:"_blank",rel:"noopener noreferrer"},v=c(`<h2 id="二分" tabindex="-1"><a class="header-anchor" href="#二分" aria-hidden="true">#</a> 二分</h2><p>第一种做法就是简单的小数二分，按照记忆中的模板测试一下：</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>int mySqrt(int x) {
    double l = 1, r = x / 2;
    while(r - l &gt; 1e-8) {
        double mid = l + (r - l) / 2;
        if(mid &lt; x / mid) l = mid;
